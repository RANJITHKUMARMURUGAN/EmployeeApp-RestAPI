...
<div class="row-content">
    ...
    <div class="profile-radio-content">
        ...
        <label>
            <g:radio id="profile5" name="profilePic" value="../assets/profile-images/Ellipse -5.png" />
            <g:img  class="profile" id="image5" dir="../assets/profile-images" file="Ellipse -5.png"/>
        </label>
    </div>
</div>
<!-- Gender -->
